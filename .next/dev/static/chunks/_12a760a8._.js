...
function Home() {
    ...
    const [plateNo, setPlateNo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            if (!res.ok) {
                ...
                setRewardMsg(data.message || (data.reward === 0 ? "😢 Oops! You got 0 pani puri free. Better luck next time!" : `✨ Congratulations! You got ${data.reward} pani puri FREE! ✨`));
