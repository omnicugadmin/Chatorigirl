...
"[project]/app/api/reward/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!plate_no || typeof plate_no !== "string") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "plate_no is required"
            }, {
                status: 400
            });
        }
        // Step 2: Check unique_tokens table
        const { data: tokenRecord, error: tokenErr } = await supabase.from("unique_tokens").select("*").eq("plate_no", plate_no).maybeSingle();
        if (tokenErr) {
        ...
        const { error: updateErr } = await supabase.from("unique_tokens").update({
            used: true,
            used_at: now
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            token: tokenRecord.token,
            reward: tokenRecord.reward,
            message: tokenRecord.reward === 0 ? "😢 Oops! You got 0 pani puri free. Better luck next time!" : `🎉 Congratulations! You got ${tokenRecord.reward} pani puri free!`
        }, {
            status: 200
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16b9e1f0._.js.map